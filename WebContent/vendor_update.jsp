   ...
   <%@ include file="header.jsp"%>
    ...
    <div class="container">
      ...
      <div class="bg-faded p-4 my-4">
        ...
        <hr class="divider">
        <form name="form" action="VendorUpdateServlet" method="post" onsubmit="return validateVendorRegitration(form);">
         <div class="row">
            ...
            <div class="form-group col-lg-4">
              ...
              <input type="password" name="vendor_password" id="vendor_password" class="form-control" value="<%=vendorBean.getVendor_password() %>" required="required">
            </div> 
