...
<br>
<%
	Logger logger=Logger.getLogger("machine_details.jsp");
...
{
	session.invalidate();
	logger.info("Try to access vendor page directly without vendor login or machine vendor is null redirected to the login page");
...
<span><a href="machine_register.jsp?machine_vendor_id=<%=machine_vendor_id %> "style="color: #151414">Add Machine</a></span>
...
<table id="myTable" align="center">
  <tr class="header" >
    ...
    <th style="width:10%;background-color:#707070;color: white;">Update</th>
		...
		<td><a href="machine_update.jsp?machine_id=<%=mb.getMachine_id()%>" style="color: #151414">Update</a></td>
		</tr>
		<%
			}
			
			logger.info("All Machine Deatils is shown in Admin Side");
		%>
